    ...
    public class CustomLoggingMiddleware
    {
        ...
        public async Task Invoke(HttpContext httpContext, ILogger<CustomLoggingMiddleware> _logger)
        {
            ...
            if (request.Path.StartsWithSegments(new PathString("/api")))
            {
                ...
                _logger.LogInformation("Custom Logging Middleware Request : " + JsonConvert.SerializeObject(requestBodyContent));
                _logger.LogInformation("Custom Logging Middleware Response : " + JsonConvert.SerializeObject(responseBodyContent));
